    ...
    btn.addEventListener("click", () => {
      ...
      const hidden =
        group.parentElement.querySelector(
          `input[name="${group.dataset.radioGroup}"]`
        );
